...
ROOT_URLCONF = 'manage_party_service.urls'
...
WSGI_APPLICATION = 'manage_party_service.wsgi.application'
...
ASGI_APPLICATION = 'manage_party_service.routing.application'
...
SWAGGER_SETTINGS = {
    ...
    'DEFAULT_AUTO_SCHEMA_CLASS': 'manage_party_service.settings.custom_setting_classes.CustomAutoSchema',
    'TAGS_SORTER': 'alpha',
    'DOC_EXPANSION': 'none',
}
